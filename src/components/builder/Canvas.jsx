      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-4 gap-2 sm:gap-0">
        ...
        <div className="flex-grow sm:order-1">
          <input
            ...
            className="w-full max-w-md border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-500 text-gray-900 text-sm transition-all duration-300 ease-in-out"
          />
        </div>
      </div>
